...
//+kubebuilder:rbac:groups=sofplicator.com,resources=replications,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=sofplicator.com,resources=replications/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=sofplicator.com,resources=replications/finalizers,verbs=update
