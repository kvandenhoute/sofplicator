...
import (
	...
	"github.com/kvandenhoute/sofplicator/operator/api/v1alpha1"
	log "github.com/sirupsen/logrus"
)

func StartReplication(replication v1alpha1.ReplicationSpec) (string, error) {
...
func StartGlobalReplication(replication v1alpha1.ReplicationSpec) (map[string]*string, error) {
